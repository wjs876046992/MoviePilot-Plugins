...
const {createTextVNode:_createTextVNode,resolveComponent:_resolveComponent,withCtx:_withCtx,createVNode:_createVNode,createElementVNode:_createElementVNode,toDisplayString:_toDisplayString,openBlock:_openBlock,createBlock:_createBlock,createCommentVNode:_createCommentVNode,mergeProps:_mergeProps,renderList:_renderList,Fragment:_Fragment,createElementBlock:_createElementBlock,normalizeClass:_normalizeClass} = await importShared('vue');
...
const _hoisted_9 = { class: "d-flex align-start justify-space-between flex-wrap ga-2 mb-2" };
const _hoisted_10 = { class: "d-flex align-center ga-3 flex-grow-1 overflow-hidden" };
const _hoisted_11 = { class: "overflow-hidden" };
const _hoisted_12 = { class: "d-flex align-center flex-wrap ga-2" };
const _hoisted_13 = { class: "text-body-2 font-weight-bold text-truncate media-title" };
const _hoisted_14 = { class: "d-flex align-center ga-2 flex-shrink-0 ml-auto" };
const _hoisted_15 = {
  key: 0,
  class: "progress-pill d-flex align-center px-2 py-1 rounded-pill"
};
const _hoisted_16 = { class: "text-caption font-weight-bold" };
const _hoisted_17 = { class: "time-label text-caption text-medium-emphasis" };
const _hoisted_18 = { class: "flow-container d-flex align-center flex-wrap ga-2 rounded-lg px-3 py-2 mt-2" };
const _hoisted_19 = { class: "flow-node d-flex align-center" };
const _hoisted_20 = { class: "text-caption text-medium-emphasis mr-1 font-weight-medium" };
const _hoisted_21 = { class: "node-user text-caption font-weight-bold" };
const _hoisted_22 = { class: "flow-arrow d-flex align-center justify-center" };
const _hoisted_23 = { class: "flow-targets d-flex align-center flex-wrap ga-1" };
const _hoisted_24 = {
  key: 0,
  class: "text-caption text-medium-emphasis mr-1"
};
const _hoisted_25 = { class: "node-user text-caption font-weight-bold" };
const _hoisted_26 = {
  key: 0,
  class: "desc-box text-caption d-flex align-center rounded-lg pa-2 mt-2"
};
const _hoisted_27 = {
  key: 1,
  class: "error-box text-caption d-flex align-start rounded-lg pa-2 mt-2"
};
const _hoisted_28 = { class: "text-break" };
const _hoisted_29 = {
  key: 0,
...
const _hoisted_30 = {
  key: 1,
  class: "text-center text-caption text-medium-emphasis pb-2"
};
const _hoisted_31 = {
  key: 1,
  class: "empty-box d-flex flex-column align-center justify-center py-12 px-4 rounded-xl text-center"
};
const _hoisted_32 = { class: "empty-icon mb-3" };
        ...
        _createVNode(_component_v_card_item, { class: "header-surface px-5 py-3 border-b" }, {
              ...
              _createVNode(_component_v_menu, { location: "bottom end" }, {
                    ...
                    default: _withCtx(() => [
                      _createVNode(_component_v_icon, { size: "18" }, {
                        default: _withCtx(() => [...(_cache[9] || (_cache[9] = [
                          _createTextVNode("mdi-dots-vertical", -1)
                        ]))]),
                        _: 1
                      }),
                      _createVNode(_component_v_tooltip, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_list, {
                    density: "compact",
                    class: "rounded-lg shadow-elevation py-1"
                  }, {
                    default: _withCtx(() => [
                      _createVNode(_component_v_list_subheader, { class: "text-caption font-weight-bold" }, {
                        default: _withCtx(() => [...(_cache[11] || (_cache[11] = [
                          _createTextVNode("清理历史日志", -1)
                        ]))]),
                        _: 1
                      }),
                      ...
                      _createVNode(_component_v_list_item, {
                        onClick: _cache[3] || (_cache[3] = $event => (clearOldRecords(0))),
                        disabled: clearing.value,
          ...
          default: _withCtx(() => [
            _createElementVNode("div", null, [
                ...
                default: _withCtx(() => [
                  ...
                  (pagination.value.total > 0)
                    ? (_openBlock(), _createBlock(_component_v_chip, {
                        ...
                        default: _withCtx(() => [
                          _createTextVNode(_toDisplayString(pagination.value.total) + " 条同步记录 ", 1)
                        ]),
                        _: 1
                      }))
              ...
              _cache[6] || (_cache[6] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "实时查看跨媒体服务器播放进度、收藏与标记同步流水", -1))
            ])
          ]),
          _: 1
        }),
          ...
          default: _withCtx(() => [
            (error.value)
              ? (_openBlock(), _createBlock(_component_v_alert, {
                  ...
                  closable: "",
                  "onClick:close": _cache[4] || (_cache[4] = $event => (error.value = null))
                }, {
                  default: _withCtx(() => [
              ...
              ? (_openBlock(), _createElementBlock("div", _hoisted_4, [
                  (_openBlock(), _createElementBlock(_Fragment, null, _renderList(4, (i) => {
                    return _createElementVNode("div", {
                      key: i,
                      class: "skeleton-card pa-4 rounded-xl"
                    }, [
              ...
              : (_openBlock(), _createElementBlock("div", _hoisted_7, [
                  (groupedSyncRecords.value && groupedSyncRecords.value.length)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_8, [
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(groupedSyncRecords.value, (group, index) => {
                          return (_openBlock(), _createElementBlock("div", {
                            key: index,
                            class: _normalizeClass(["record-stream-card rounded-xl pa-3 pa-sm-4 transition-fast", group.status === 'error' ? 'stream-card-error' : 'stream-card-success'])
                          }, [
                            _createElementVNode("div", _hoisted_9, [
                              _createElementVNode("div", _hoisted_10, [
                                _createElementVNode("div", {
                                  class: _normalizeClass(["status-indicator-box flex-shrink-0", `indicator-${group.status === 'error' ? 'error' : 'success'}`])
                                }, [
                                  _createVNode(_component_v_icon, {
                                    size: "16",
                                ...
                                _createElementVNode("div", _hoisted_11, [
                                  _createElementVNode("div", _hoisted_12, [
                                    _createElementVNode("span", _hoisted_13, _toDisplayString(group.media_name || '未命名媒体'), 1),
                                    _createVNode(_component_v_chip, {
                                      ...
                                      default: _withCtx(() => [
                                        _createTextVNode(_toDisplayString(group.media_type || '媒体'), 1)
                                      ]),
                                      _: 2
                                    }, 1032, ["color"]),
                                    _createVNode(_component_v_chip, {
                                      ...
                                      default: _withCtx(() => [
                                        ...
                                        _createTextVNode(" " + _toDisplayString(getEventDescription(group.sync_type) || group.sync_type), 1)
                                      ]),
                                      _: 2
                                    }, 1032, ["color"])
                                  ])
                              ...
                              _createElementVNode("div", _hoisted_14, [
                                (group.position_ticks)
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_15, [
                                      ...
                                      _createElementVNode("span", _hoisted_16, _toDisplayString(formatProgress(group.position_ticks)), 1)
                                    ]))
                                  : _createCommentVNode("", true),
                                _createElementVNode("div", _hoisted_17, _toDisplayString(formatTime(group.timestamp || group.created_at)), 1)
                              ])
                            ]),
                            _createElementVNode("div", _hoisted_18, [
                              _createElementVNode("div", _hoisted_19, [
                                ...
                                _createElementVNode("span", _hoisted_20, _toDisplayString(group.source_server || '源服务器'), 1),
                                _createElementVNode("span", _hoisted_21, _toDisplayString(group.source_user), 1)
                              ]),
                              _createElementVNode("div", _hoisted_22, [
                                _createVNode(_component_v_icon, {
                                  ...
                                  default: _withCtx(() => [...(_cache[18] || (_cache[18] = [
                                    _createTextVNode("mdi-arrow-right-thin", -1)
                                  ]))]),
                                  _: 1
                                })
                              ]),
                                  ...
                                  return (_openBlock(), _createElementBlock("div", {
                                    ...
                                    _createVNode(_component_v_icon, {
                                      ...
                                      default: _withCtx(() => [...(_cache[19] || (_cache[19] = [
                                        _createTextVNode("mdi-account-check-outline", -1)
                                      ]))]),
                                      _: 1
                                    }, 8, ["color"]),
                                    (group.target_server)
                                      ? (_openBlock(), _createElementBlock("span", _hoisted_24, _toDisplayString(group.target_server) + ":", 1))
                                      : _createCommentVNode("", true),
                                    _createElementVNode("span", _hoisted_25, _toDisplayString(target_user), 1)
                                  ]))
                                }), 128))
                              ])
                            ]),
                            ...
                            (group.error_message)
                              ? (_openBlock(), _createElementBlock("div", _hoisted_27, [
                                  ...
                                  _createElementVNode("span", _hoisted_28, _toDisplayString(group.error_message), 1)
                                ]))
                              : _createCommentVNode("", true)
                          ], 2))
                        }), 128)),
                        (pagination.value.hasMore)
                                ...
                                default: _withCtx(() => [
                                  _createVNode(_component_v_icon, {
                                    ...
                                    default: _withCtx(() => [...(_cache[22] || (_cache[22] = [
                                      _createTextVNode("mdi-chevron-double-down", -1)
                                    ]))]),
                                    _: 1
                                  }),
                                  _cache[23] || (_cache[23] = _createTextVNode(" 加载更多历史记录 ", -1))
                                ]),
                                _: 1
                              }, 8, ["loading"])
                            ]))
                          : _createCommentVNode("", true),
                        (pagination.value.total > 0)
                          ? (_openBlock(), _createElementBlock("div", _hoisted_30, " 已加载 " + _toDisplayString(syncRecords.value.length) + " / 共 " + _toDisplayString(pagination.value.total) + " 条记录 ", 1))
                          : _createCommentVNode("", true)
                      ]))
                    : (_openBlock(), _createElementBlock("div", _hoisted_31, [
                        ...
                        _cache[27] || (_cache[27] = _createElementVNode("div", { class: "text-subtitle-2 font-weight-bold text-medium-emphasis" }, "暂无同步流水记录", -1)),
                        _cache[28] || (_cache[28] = _createElementVNode("div", {
                          class: "text-caption text-disabled mt-1",
                          style: {"max-width":"320px"}
                        }, " 当配置保存生效并在受支持的多端播放、标记时，所有自动同步的历史状态将在此处实时归档。 ", -1)),
                        _createVNode(_component_v_btn, {
                          color: "primary",
                          variant: "tonal",
                          size: "small",
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[26] || (_cache[26] = _createTextVNode(" 前往检查同步配置 ", -1))
                          ]),
                          _: 1
                        })
                      ]))
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-0dbe4105"]]);
