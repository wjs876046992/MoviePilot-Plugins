...
const _hoisted_15 = { class: "action-strip rounded-xl pa-3 mb-4" };
const _hoisted_16 = { class: "action-strip-row d-flex flex-column flex-sm-row align-stretch align-sm-center justify-sm-space-between ga-2" };
...
const _hoisted_22 = { class: "text-caption text-medium-emphasis batch-hint" };
const _hoisted_23 = { key: 1 };
const _hoisted_24 = {
  key: 0,
  class: "d-flex flex-column ga-2"
};
const _hoisted_25 = { class: "list-row-main d-flex align-center overflow-hidden mr-sm-3 mr-0" };
const _hoisted_26 = { class: "overflow-hidden" };
const _hoisted_27 = { class: "font-weight-bold text-body-2 text-truncate" };
const _hoisted_28 = { class: "text-caption text-medium-emphasis mt-0.5" };
const _hoisted_29 = {
  key: 0,
...
const _hoisted_31 = { class: "list-row-actions d-flex align-center flex-wrap ga-1 flex-shrink-0" };
const _hoisted_32 = {
  key: 1,
...
const _hoisted_45 = { class: "d-flex align-center flex-wrap ga-2 mb-2" };
const _hoisted_46 = { class: "font-weight-bold text-body-2" };
const _hoisted_47 = { class: "text-caption text-medium-emphasis" };
const _hoisted_48 = { class: "d-flex flex-column ga-2" };
const _hoisted_49 = { class: "list-row-main d-flex align-center overflow-hidden mr-sm-3 mr-0" };
const _hoisted_50 = { class: "overflow-hidden" };
const _hoisted_51 = { class: "font-weight-bold text-body-2 text-warning text-truncate" };
const _hoisted_52 = { class: "list-row-actions d-flex align-center flex-wrap ga-1 flex-shrink-0" };
const _hoisted_53 = { key: 3 };
const _hoisted_54 = {
  key: 0,
  class: "d-flex flex-column ga-2"
};
const _hoisted_55 = { class: "list-row-main overflow-hidden mr-sm-3 mr-0" };
const _hoisted_56 = { class: "font-weight-bold text-body-2 text-truncate" };
const _hoisted_57 = { class: "text-caption text-medium-emphasis mt-0.5" };
      ...
      default: _withCtx(() => [
            ...
            _createElementVNode("div", _hoisted_3, [
              ...
              _createVNode(_component_v_btn, {
                ...
                default: _withCtx(() => [
                  ...
                  _cache[15] || (_cache[15] = _createTextVNode(" 配置 ", -1))
                ]),
                _: 1
              }),
              _createVNode(_component_v_btn, {
          ...
          default: _withCtx(() => [
            _createElementVNode("div", null, [
              _createVNode(_component_v_card_title, { class: "text-subtitle-1 font-weight-bold pa-0 d-flex align-center flex-wrap ga-2" }, {
                default: _withCtx(() => [
                  _cache[10] || (_cache[10] = _createElementVNode("span", null, "115 网盘同步监控", -1)),
              ...
              _cache[11] || (_cache[11] = _createElementVNode("div", { class: "header-subtitle text-caption text-medium-emphasis" }, "监控入库延迟冷却进度、双向对账异常与一键快速定向重试", -1))
            ])
          ]),
          _: 1
        }),
        _createVNode(_component_v_card_text, { class: "pa-4 flex-grow-1 overflow-y-auto body-surface" }, {
          default: _withCtx(() => [
                ...
                _createVNode(_component_v_col, {
                  ...
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_7, [
                      ...
                      _cache[18] || (_cache[18] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mt-1" }, "冷却就绪待传输", -1))
                    ])
                  ]),
                  _: 1
                }),
                _createVNode(_component_v_col, {
                  ...
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_9, [
                      ...
                      _cache[19] || (_cache[19] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mt-1" }, "待重试缺失/残缺文件", -1))
                    ])
                  ]),
                  _: 1
                })
            ...
            (statusData.value.backfill_remaining || isThrottled.value || statusData.value.missed_count || statusData.value.stale_count)
                  ...
                  default: _withCtx(() => [
                    ...
                    (statusData.value.backfill_remaining)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_12, [
                          _cache[20] || (_cache[20] = _createTextVNode(" 存量补传进行中：剩余 ", -1)),
                    ...
                    (statusData.value.stale_count)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_13, [
                          _cache[21] || (_cache[21] = _createTextVNode(" 🗑️ ", -1)),
                          _createElementVNode("strong", null, _toDisplayString(statusData.value.stale_count), 1),
                          _cache[22] || (_cache[22] = _createTextVNode(" 个队列条目的源文件已从本地删除， 将在下轮同步时自动移出（不计入上方「冷却中 / 就绪」数字）。 ", -1))
                        ]))
                      : _createCommentVNode("", true),
                    (statusData.value.missed_count)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_14, [
                          _cache[23] || (_cache[23] = _createTextVNode(" 🕳️ 检测到 ", -1)),
                          _createElementVNode("strong", null, _toDisplayString(statusData.value.missed_count), 1),
                          _cache[24] || (_cache[24] = _createTextVNode(" 个文件可能因插件重载错过了入库事件， 已由源端扫描补回，将在下次同步时一并上传（这些文件不再等待冷却）。 ", -1))
                        ]))
                      : _createCommentVNode("", true)
                  ]),
                  _: 1
            ...
            _createElementVNode("div", _hoisted_15, [
              _createElementVNode("div", _hoisted_16, [
                _createElementVNode("div", _hoisted_17, [
                  _createVNode(_component_v_btn, {
                    ...
                    default: _withCtx(() => [
                      ...
                      _cache[26] || (_cache[26] = _createTextVNode(" 同步已就绪媒体 ", -1))
                    ]),
                    _: 1
                  }, 8, ["loading", "disabled"]),
                  _createVNode(_component_v_btn, {
                    ...
                    default: _withCtx(() => [
                      ...
                      _cache[28] || (_cache[28] = _createTextVNode(" 定向重试失败文件 ", -1))
                    ]),
                    _: 1
                  }, 8, ["loading", "disabled"]),
                  _createVNode(_component_v_btn, {
                    ...
                    default: _withCtx(() => [
                      ...
                      _cache[31] || (_cache[31] = _createTextVNode(" 补传存量媒体 ", -1)),
                      _createVNode(_component_v_tooltip, {
                        activator: "parent",
                        location: "top"
                      }, {
                  ...
                  (statusData.value.backfill_remaining)
                    ? (_openBlock(), _createBlock(_component_v_btn, {
                        ...
                        default: _withCtx(() => [
                          ...
                          _cache[33] || (_cache[33] = _createTextVNode(" 取消补传 ", -1))
                        ]),
                        _: 1
                      }, 8, ["disabled"]))
                    : _createCommentVNode("", true)
                ...
                _createElementVNode("div", _hoisted_18, [
                  (actionMsg.value)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_19, _toDisplayString(actionMsg.value), 1))
                    : _createCommentVNode("", true),
              ...
              (selectMode.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_20, [
                    _createVNode(_component_v_checkbox, {
                      ...
                      label: _withCtx(() => [
                        _createElementVNode("span", _hoisted_21, "全选本页 (" + _toDisplayString(selectableItems.value.length) + ")", 1)
                      ]),
                      _: 1
                    }, 8, ["model-value", "indeterminate"]),
                    _createElementVNode("span", _hoisted_22, "已选 " + _toDisplayString(selectedKeys.value.length) + " 项 · 可跨分组勾选后一次性上传统一触发", 1)
                  ]))
                : _createCommentVNode("", true)
            ]),
              ...
              ? (_openBlock(), _createElementBlock("div", _hoisted_23, [
                          ...
                          return (_openBlock(), _createElementBlock("div", {
                            ...
                            _createElementVNode("div", _hoisted_25, [
                              ...
                              _createElementVNode("div", _hoisted_26, [
                                _createElementVNode("div", _hoisted_27, _toDisplayString(item.key), 1),
                                _createElementVNode("div", _hoisted_28, [
                                  _createTextVNode(" 入库时间: " + _toDisplayString(item.enter_time) + " ", 1),
                                  (!item.is_ready)
                                    ? (_openBlock(), _createElementBlock("span", _hoisted_29, " (还需冷却等待 " + _toDisplayString(Math.ceil(item.remaining_seconds / 60)) + " 分钟) ", 1))
                                    : (_openBlock(), _createElementBlock("span", _hoisted_30, " (已达到冷却时间，随时可同步) "))
                                ])
                              ])
                            ]),
                            _createElementVNode("div", _hoisted_31, [
                              ...
                              _createVNode(_component_v_btn, {
                                ...
                                default: _withCtx(() => [
                                  ...
                                  _cache[40] || (_cache[40] = _createTextVNode(" 立即同步 ", -1)),
                                  _createVNode(_component_v_tooltip, {
                                    activator: "parent",
                                    location: "top"
                                  }, {
                  ...
                  (paged.value.pages > 1)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_32, [
                        _createVNode(_component_v_btn, {
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[42] || (_cache[42] = _createTextVNode("上一页 ", -1))
                          ]),
                          _: 1
                        }, 8, ["disabled"]),
                        _createElementVNode("span", _hoisted_33, [
                          _cache[43] || (_cache[43] = _createTextVNode(" 第 ", -1)),
                        ...
                        _createVNode(_component_v_btn, {
                          ...
                          default: _withCtx(() => [
                            _cache[45] || (_cache[45] = _createTextVNode(" 下一页", -1)),
                            _createVNode(_component_v_icon, {
                              end: "",
                              size: "16"
                            }, {
                    ...
                    : (_openBlock(), _createElementBlock("div", _hoisted_34, [
                        ...
                        _cache[47] || (_cache[47] = _createElementVNode("div", { class: "text-caption font-weight-bold text-medium-emphasis" }, "暂无正在冷却中的媒体文件", -1))
                      ]))
                ]))
              : _createCommentVNode("", true),
              ...
              ? (_openBlock(), _createElementBlock("div", _hoisted_35, [
                          ...
                          return (_openBlock(), _createElementBlock("div", {
                            ...
                            _createElementVNode("div", _hoisted_37, [
                              ...
                              _createElementVNode("div", _hoisted_38, [
                                ...
                                _createElementVNode("div", _hoisted_39, _toDisplayString(entry.kind === 'missing' ? '本地已入库，但 115 网盘端尚未同步到位' : '目标端大小不一致，传输中途断流'), 1)
                              ])
                            ]),
                            _createElementVNode("div", _hoisted_40, [
                              ...
                              _createVNode(_component_v_btn, {
                                ...
                                default: _withCtx(() => [
                                  ...
                                  _cache[50] || (_cache[50] = _createTextVNode(" 重试 ", -1)),
                                  _createVNode(_component_v_tooltip, {
                                    activator: "parent",
                                    location: "top"
                                  }, {
                  ...
                  (paged.value.pages > 1)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_41, [
                        _createVNode(_component_v_btn, {
                          ...
                          default: _withCtx(() => [
                            ...
                            _cache[54] || (_cache[54] = _createTextVNode("上一页 ", -1))
                          ]),
                          _: 1
                        }, 8, ["disabled"]),
                        _createElementVNode("span", _hoisted_42, [
                          _cache[55] || (_cache[55] = _createTextVNode(" 第 ", -1)),
                          _createElementVNode("strong", null, _toDisplayString(paged.value.page), 1),
                          _createTextVNode(" / " + _toDisplayString(paged.value.pages) + " 页 · 共 " + _toDisplayString(paged.value.total) + " 条（每页 " + _toDisplayString(PAGE_SIZE) + " 条） ", 1)
                        ]),
                        _createVNode(_component_v_btn, {
                          ...
                          default: _withCtx(() => [
                            _cache[57] || (_cache[57] = _createTextVNode(" 下一页", -1)),
                            _createVNode(_component_v_icon, {
                              end: "",
                              size: "16"
                            }, {
                    ...
                    : (_openBlock(), _createElementBlock("div", _hoisted_43, [
                        ...
                        _cache[59] || (_cache[59] = _createElementVNode("div", { class: "text-caption font-weight-bold text-medium-emphasis" }, "冷却队列与待重试文件经对账全部一致，零缺失零残缺！", -1))
                      ])),
                  (strmSuspectCount.value)
                    ? (_openBlock(), _createElementBlock("div", _hoisted_44, [
                        _createElementVNode("div", _hoisted_45, [
                          ...
                          _createElementVNode("span", _hoisted_46, "strm 疑似上传异常 (" + _toDisplayString(strmSuspectCount.value) + ")", 1),
                          _createElementVNode("span", _hoisted_47, " 观察期 " + _toDisplayString(statusData.value.strm_grace_hours) + "h 内未生成对应 strm；处理前请确认 strm 插件本身正常 ", 1)
                        ]),
                        _createElementVNode("div", _hoisted_48, [
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(strmSuspectKeys.value, (key) => {
                            return (_openBlock(), _createElementBlock("div", {
                              key: 's-' + key,
                              class: "failed-item-card d-flex flex-column flex-sm-row align-stretch align-sm-center justify-sm-space-between rounded-xl pa-3 ga-2"
                            }, [
                              _createElementVNode("div", _hoisted_49, [
                                _createElementVNode("div", _hoisted_50, [
                                  _createElementVNode("div", _hoisted_51, _toDisplayString(key), 1),
                                  _cache[61] || (_cache[61] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mt-0.5" }, " 同步已报告成功，但宽限期内未见 strm 生成 —— 可能上传未真正完成 ", -1))
                                ])
                              ]),
                              _createElementVNode("div", _hoisted_52, [
                                ...
                                _createVNode(_component_v_btn, {
                                  ...
                                  default: _withCtx(() => [
                                    ...
                                    _cache[65] || (_cache[65] = _createTextVNode(" 删旧重传 ", -1)),
                                    _createVNode(_component_v_tooltip, {
                                      activator: "parent",
                                      location: "top"
                                    }, {
              ...
              ? (_openBlock(), _createElementBlock("div", _hoisted_53, [
                        ...
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(ignoredPaged.value.slice, (rule, idx) => {
                          return (_openBlock(), _createElementBlock("div", {
                            ...
                            _createElementVNode("div", _hoisted_55, [
                              _createElementVNode("div", _hoisted_56, _toDisplayString(rule.rule), 1),
                              _createElementVNode("div", _hoisted_57, [
                                _createTextVNode(_toDisplayString(rule.match === 'exact' ? '精确匹配' : '包含匹配') + " · 加入于 " + _toDisplayString(rule.created_at) + " ", 1),
                                (rule.created_by)
                                  ? (_openBlock(), _createElementBlock("span", _hoisted_58, " · 操作人 " + _toDisplayString(rule.created_by), 1))
                                  : _createCommentVNode("", true)
                              ])
                            ]),
                  ...
                  (paged.value.pages > 1)
                    ...
                    : (_openBlock(), _createElementBlock("div", _hoisted_62, [
                        ...
                        _cache[75] || (_cache[75] = _createElementVNode("div", { class: "text-caption font-weight-bold text-medium-emphasis" }, "当前没有忽略任何文件", -1))
                      ]))
                ]))
              : _createCommentVNode("", true)
          ]),
...
const App = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-00bd5a08"]]);
